...
import com.example.chenghao.mytb.Fragments.WebFragment;
...
public class WebTestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter adapter=new SimpleAdapter(WebTestActivity.this,
                getITEM(),
        ...
        fragmentTransaction.add(R.id.fragment_container,new WebFragment());
